CREATE PROCEDURE Attendance.ReturnPointSourcePageReport (
	@startDate Date
	, @endDate Date
...
BEGIN
	SELECT
		...
		, COUNT(CASE PageSource WHEN 1 THEN 1 END) LiveLessonsCount
		, COUNT(CASE PageSource WHEN 2 THEN 1 END) StudentsCount
