CREATE PROCEDURE Attendance.ReturnPointSourceStaffReport (
	@startDate DATE
	, @endDate DATE
...
BEGIN
	SELECT
		...
		, COUNT(CASE UserSource WHEN 1 THEN 1 END) MentorCount
		, COUNT(CASE UserSource WHEN 2 THEN 1 END) TeacherCount
		, COUNT(CASE UserSource WHEN 4 THEN 1 END) OtherCount
